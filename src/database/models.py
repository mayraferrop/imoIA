...
class Opportunity(Base):
    ...
    opportunity_type: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    property_type: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    location_extracted: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
